...
const handleCreatePostsCategorie = async (categoryId, newPost) => {
  if (typeof categoryId === 'object') {
    ...
    if (!createPostsCategorie) throw new Error('"createPostsCategorie" error to create');
  } 
  // else {
...
const createNewPost = async (userId, title, content, categoryId) => {
  ...
  await handleCreatePostsCategorie(categoryId, newPost);
